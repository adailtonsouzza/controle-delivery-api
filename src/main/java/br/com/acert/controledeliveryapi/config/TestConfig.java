...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Pedido p1 = new Pedido(null, Instant.parse("2022-09-07T19:53:07Z"), c1);
        Pedido p2 = new Pedido(null, Instant.parse("2022-09-07T03:42:10Z"), c2);
        Pedido p3 = new Pedido(null, Instant.parse("2022-09-07T15:21:22Z"), c1);
